...
public class ClienteDaoJDBC {
    ...
    private static final String SQL_INSERT = "INSERT INTO propiedad (nombre, apellido, numero_celular, bloque, apartamento) "
            + " VALUES(?, ?, ?, ?)";

    private static final String SQL_UPDATE = "UPDATE propiedad SET nombre=?, apellido=?, numero_celular=?, bloque=?, apartamento=? "
            + " WHERE id_propiedad=?";

    private static final String SQL_DELETE = "DELETE FROM propiedad WHERE id_propiedad = ?";
